...
autodownloader(50,'Medical Facilities in Delaware')
autodownloader(50,'Medical Facilities in New Jersey')
autodownloader(50,'Medical Facilities in New York')
autodownloader(50,'Medical Facilities in Connecticut')
autodownloader(50,'Medical Facilities in Rhode Island')
autodownloader(50,'Medical Facilities in Massachusetts')
autodownloader(50,'Medical Facilities in New Hampshire')
autodownloader(50,'Medical Facilities in Vermont')
autodownloader(50,'Medical Facilities in Maine')
autodownloader(50,'Medical Facilities in Tennessee')
autodownloader(50,'Medical Facilities in North Carolina')
autodownloader(50,'Medical Facilities in South Carolina')
autodownloader(50,'Medical Facilities in Georgia')
